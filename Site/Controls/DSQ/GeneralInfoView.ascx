...
<div class="clearfix">
    ...
    <div class="form-info drug-view-eocs">
		...
		<span class="eoc-icon eoc-icon-patient-enrollment<%=(EocIsCertified("patient-enrollment") ? "" : " disabled") %>">
			<a href="/api/Users/Certified?id=<%=item.ID %>&eoc_name=patient-enrollment" class="ajax-button" onclick="return $(this).parent().is('.disabled');"><img src="/images/icons/PAEN.png" alt="Patient Enrollment" /></a>
		</span>
		<% } %>
		...
		<span class="eoc-icon eoc-icon-prescriber-enrollment<%=(EocIsCertified("prescriber-enrollment") ? "" : " disabled") %>">
			<a href="/api/Users/Certified?id=<%=item.ID %>&eoc_name=prescriber-enrollment" class="ajax-button" onclick="return $(this).parent().is('.disabled');"><img src="/images/icons/PREN.png" alt="Prescriber Enrollment" /></a>
		</span>
		<% } %>
		...
		<span class="eoc-icon eoc-icon-education-training<%=(EocIsCertified("education-training") ? "" : " disabled") %>">
			<a href="/api/Users/Certified?id=<%=item.ID %>&eoc_name=education-training" class="ajax-button" onclick="return $(this).parent().is('.disabled');"><img src="/images/icons/EDUCRT.png" alt="Education/Certification" /></a>
		</span>
		<% } %>
		...
		<span class="eoc-icon eoc-icon-facility-pharmacy-enrollment<%=(EocIsCertified("facility-pharmacy-enrollment") ? "" : " disabled") %>">
			<a href="/api/Users/Certified?id=<%=item.ID %>&eoc_name=facility-pharmacy-enrollment" class="ajax-button" onclick="return $(this).parent().is('.disabled');"><img src="/images/icons/FP EN.png" alt="Facility/Pharmacy Enrollment" /></a>
		</span>
		<% } %>
		...
		<span class="eoc-icon eoc-icon-pharmacy-requirements<%=(EocIsCertified("pharmacy-requirements") ? "" : " disabled") %>">
			<a href="/api/Users/Certified?id=<%=item.ID %>&eoc_name=pharmacy-requirements" class="ajax-button" onclick="return $(this).parent().is('.disabled');"><img src="/images/icons/PR.png" alt="Pharmacy Requirements" /></a>
		</span>
		<% } %>
		<% } %>
	</div>
