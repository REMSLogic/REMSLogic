...
<body class="login" style="overflow: hidden;">
    ...
    <div class="login-box">
        <section class="login-box-top">
            ...
            <section>
                <form id="form" class="has-validation" action="/App/Login.aspx<%=string.IsNullOrEmpty(Request.Url.Fragment) ? "" : "?frag="+Request.Url.Fragment.Substring(1) %>" method="post" style="margin-top: 30px">
