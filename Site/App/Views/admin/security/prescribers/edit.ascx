...
<div class="container_12 clearfix leading">
    <div class="grid_12">
		...
		<form class="form has-validation ajax-form" action="/api/Admin/Security/Prescriber/Edit?id=<%=((item.ID == null) ? 0 : item.ID)%>">
			...
			<div class="clearfix">
                <label for="form-npiid" class="form-label">NPI ID <em>*</em></label>
                <div class="form-input"><input type="text" id="form-npiid" name="npiid" required="required" placeholder="Enter the NPI ID" value="<%=item.NpiId%>" /></div>
            </div>
