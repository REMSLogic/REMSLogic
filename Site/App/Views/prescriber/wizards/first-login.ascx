<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="first-login.ascx.cs" Inherits="Site.App.Views.prescriber.wizards.FirstLogin" %>
...
<div class="container_12 clearfix leading">
    <div class="grid_12">
        <form action="/api/Prescriber/Wizards/FirstLogin?id=<%=PrescriberProfile.ID%>" class="wizard form ajax-form" novalidate>
            <nav>
                <ul class="clearfix">
                    <li class="active"><strong>1.</strong> Terms of Service</li>
                    <li><strong>2.</strong> Account</li>
                    <li><strong>3.</strong> Intro</li>
                    <li><strong>4.</strong> Personal Information</li>
                    <li><strong>5.</strong> Prescriber Details</li>
                </ul>
            </nav>
            <div class="items" >
                <!-- page1 -->
                <section>
                    ...
                    <footer class="clearfix">
                        <button type="button" class="next fr tos-proceed-button" disabled>Proceed &raquo;</button>
                    </footer>
                </section>
                ...
                <section>
                    <header>
                        <h2>
                            <strong>Step 2:</strong> Change Password
                ...
                <section>
                    ...
                    <footer class="clearfix">
                        <button type="button" class="prev fl">&laquo; Back</button>
                        <button type="button" class="next fr video-proceed-button" disabled>Proceed &raquo;</button>
                    </footer>
                </section>
                ...
                <section>
                    <header>
                        <h2>
                            <strong>Step 4:</strong> Personal Information
                        ...
                        <div class="grid_12" style="margin-bottom: 20px;">
                            <div class="form">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="form-input"><input type="text" id="form-first-name" name="first-name" placeholder="Enter your first name" value="" required="required" /></div>
                                </div>
                                
                                <div class="clearfix">
                                    <label for="form-last-name" class="form-label">Last Name <em>*</em></label>
                                    <div class="form-input"><input type="text" id="form-last-name" name="last-name" placeholder="Enter your last name" value="" required="required" /></div>
                                </div>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="form-input"><input type="text" id="form-phone" name="phone" placeholder="Enter your phone number" value="" /></div>
                                </div>
                                
                                <div class="clearfix">
                                    <label for="form-fax" class="form-label">Fax Number</label>
                                    <div class="form-input"><input type="text" id="form-fax" name="fax" placeholder="Enter your fax number" value="" /></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid_12">
                            <div class="form">
                                <div class="clearfix">
                                    ...
                                    <div class="form-input"><input type="text" id="form-street-1" name="street-1" placeholder="Enter your street" value="" required="required" /></div>
                                </div>

                                <div class="clearfix">
                                    <label for="form-street-2" class="form-label">Street 2</label>
                                    <div class="form-input"><input type="text" id="form-street-2" name="street-2" placeholder="" value="" /></div>
                                </div>
                                
                                <div class="clearfix">
                                    <label for="form-city" class="form-label">City <em>*</em></label>
                                    <div class="form-input"><input type="text" id="form-city" name="city" placeholder="Enter your city" value="" required="required" /></div>
                                </div>
                                
                                <div class="clearfix">
                                    <label for="form-state" class="form-label">State <em>*</em></label>
                                    <div class="form-input"><input type="text" id="form-state" name="state" placeholder="Enter your state" value="" required="required" /></div>
                                </div>
                                
                                <div class="clearfix">
                                    <label for="form-zip" class="form-label">Zip <em>*</em></label>
                                    <div class="form-input"><input type="text" id="form-zip" name="zip" placeholder="Enter your zip code" value="" required="required" /></div>
                                </div>
                                
                                <div class="clearfix">
                                    <label for="form-country" class="form-label">Country <em>*</em></label>
                                    <div class="form-input"><input type="text" id="form-country" name="country" placeholder="Enter your country" value="" required="required" /></div>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <section>
                    <header>
                        <h2>
                            <strong>Step 5:</strong> Prescriber Details
