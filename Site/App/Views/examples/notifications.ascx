<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="notifications.ascx.cs" Inherits="Site.App.Views.examples.notifications" %>

<link rel="stylesheet" media="screen" href="/App/css/notifications.css" />
<script type="text/javascript" src="/App/js/jquery.ui.widget.min.js"></script>
