<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="form1.ascx.cs" Inherits="Site.App.Views.examples.form1" %>
    ...
    <div class="grid_12">
        <form class="form has-validation">
            ...
            <div class="clearfix">
                ...
                <div class="form-input"><input type="password" id="form-password-check" name="check" equalTo="password" maxlength="30" placeholder="Re-enter your password" /></div>
