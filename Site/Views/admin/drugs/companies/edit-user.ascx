<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="edit-user.ascx.cs" Inherits="Site.App.Views.admin.drugs.companies.edit_user" %>

<h1 class="page-title">Edit Drug Company User</h1>
<div class="container_12 clearfix leading">
    <div class="grid_12">
		<a class="button back-button" href="#" style="margin-bottom: 10px;">Back</a>
		<form class="form has-validation ajax-form" action="/api/Admin/Security/DrugCompanyUser/Edit?id=<%=((item.ID == null) ? 0 : item.ID)%>">
			<input type="hidden" name="parent-id" value="<%=Company.ID.Value %>" />
