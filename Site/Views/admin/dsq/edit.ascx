...
<script type="text/javascript" src="/js/remslogic.section.editor.js"></script>
<script type="text/javascript" src="/js/remslogic.dsq.editor.js"></script>
<script type="text/javascript">
    var default_section = <%=(this.SectionIndex >= 0) ? this.SectionIndex.ToString() : "null" %>;
</script>
<script type="text/javascript" src="/js/dsq.js"></script>
...
<div class="container_12 clearfix leading">
    <div class="grid_12">
		...
		<form id="frmEditDrug" class="has-validation dsq-form" action="/api/Dev/DSQ/Drug/Edit?id=<%=((item == null || item.ID == null) ? 0 : item.ID)%>">
			...
			<div class="clearfix">
				<site:DSQ ID="dsqView" GeneralInfoControlPath="~/Controls/DSQ/GeneralInfo.ascx" runat="server" />
			</div>
