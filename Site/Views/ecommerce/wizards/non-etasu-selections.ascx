<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="non-etasu-selections.ascx.cs" Inherits="Site.Views.ecommerce.wizards.non_etasu_selection" %>
...
<div class="container_12 clearfix leading">  
    <div class="grid_12">
        ...
        <form class="form ajax-form" action="/api/Ecommerce/Wizards/NonETASUSelections">
            ...
            <div class="form-action clearfix" style="margin-left: 74%;">
                <div style="display: none;">
                    <!-- Work around for framework design flaw -->
                    <input type="checkbox" name="drug-selections[]" value="0" checked="checked" />
                </div>
