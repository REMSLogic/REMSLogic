<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="registration-wizard.ascx.cs" Inherits="Site.Views.ecommerce.wizards.registration_wizard" %>
...
<div class="container_12 clearfix leading">
    <div class="grid_12">
        <form action="/api/Ecommerce/Wizards/Registration?id=<%=PrescriberProfile.ID%>" class="wizard form ajax-form" novalidate>
            <nav>
                <ul class="clearfix">
...
<p><b>Terms of Service for REMS Logic</b></p>
<p>Introduction </p>

<p>Welcome to REMS Logic. This website is owned and operated by REMS Logic, LLC. By visiting our website and accessing the information, resources, services, products, and tools we provide, you understand and agree to accept and adhere to the following terms and conditions as stated in this policy (hereafter referred to as ‘User Agreement’), along with the terms and conditions as stated in our Privacy Policy (please refer to the Privacy Policy section below for more information). </p>

<p>This agreement is in effect as of May 1st, 2014. </p>
...
iv) Impersonates any person or entity, including any REMSLogic employees or representatives.<br />
</p>
...
vi) no information or advice, whether expressed, implied, oral or written, obtained by you from REMSLogic, LLC or through any Resources we provide shall create any warranty, guarantee, or conditions of any kind, except for those expressly outlined in this User Agreement.
</p>
...
<p>All content and materials available on REMS Logic, including but not limited to text, graphics, website name, code, images and logos are the intellectual property of REMS Logic, LLC, and are protected by applicable copyright and trademark law. Any inappropriate use, including but not limited to the reproduction, distribution, display or transmission of any content on this site is strictly prohibited, unless specifically authorized by REMS Logic, LLC. </p>
...
USA <br />
                        ...
                        <div class="agree-checkbox">
                            I agree to the terms of service. <input type="checkbox" name="agree-to-terms" required="required" /> 
                        </div>
                    </section>
                ...
                <section>
                    <header>
                        <h2>
                            <strong>Step 2:</strong> Video
                            <em>Please view the 7 minute instructional video and check the box to proceed::</em>
                        </h2>
                    </header>
                    ...
                    <section>
                          <video id="training_video_1" class="video-js vjs-default-skin" controls preload="none" width="100%" height="600"
                            ...
                            <div class="agree-checkbox">
                            I watched the complete video. <input type="checkbox" name="watched-video" required="required" /> 
                            </div>
                    </section>
                ...
                <section>
                    <header>
                        <h2>
                            <strong>Step 3:</strong> Personal Information
                ...
                <section>
                    <header>
                        <h2>
                            <strong>Step 4:</strong> Prescriber Details
                        ...
                        <div class="grid_12">
                            <div class="form">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="form-input">
                                        <input type="text" id="form-state-id" name="state-id" placeholder="Enter your State Id" value="<%=Prescriber.StateId%>" />
                                    </div>
                                </div>
