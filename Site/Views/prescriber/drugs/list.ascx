        ...
        <header>
			<h2 class="title-header">My Drug List</h2>
                <div class="drug-list-options">
                    ...
                    <span class="add-drugs-btn-2" id="eoc-menu-toggle"> <img class="eoc-menu-toggle" style="float: right; margin-top: 0px; margin-right: 0px;" src="/images/dashboard-icon.png" alt="Filter Menu" width="24" height="24"/></span>
